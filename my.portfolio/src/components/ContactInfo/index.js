        ...
        return (
            <div>
                <div className="col-md-12">
                    <img src={require('./img/work.profile_pic.jpeg')} alt={"portPhoto"} className="portImage" />
                </div>
            ...
            repos and projects.</p>
                ...
                <div className="glowBtns">
                    <ul>
                        ...
                        <li><a href="https://www.upwork.com/freelancers/~014a06d8859dfbd50e" rel='noreferrer' target="_blank"><img src={require('./img/favicon.ico')} alt="Upwork" className="fab fa-upwork" /></a>
                        </li>
                    </ul>
                </div>
            </div>
