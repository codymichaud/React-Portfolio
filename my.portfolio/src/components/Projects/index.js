            ...
            <div className="portProjects col-lg-12">
                <div className="lyricityCont col-12">
                    <div className="clearProj">
                        <img src="./assets/imgs/Lyricity.PNG" alt="lyricity" className="lyricityImg container-fluid" />
                ...
                <div className="codeQCont col-12">
                    <div className="clear">
                        <img src="./assets/imgs/coding.quiz.PNG" alt="Coding Quiz" className="codeQImg container-fluid" />
                ...
                <div className="latteDCont col-12">
                    <div className="clearLatte">
                        <img src="./assets/imgs/latte.Daa.PNG" alt="Latte Daa" className="latteDImg container-fluid" />
                ...
                <div className="noteTakerCont col-12">
                    <div className="clearNote">
                        <img src="./assets/imgs/Notetaker.PNG" alt="Latte Daa" className="noteTakerImg container-fluid" />
                ...
                <div className="leesReptCont col-12">
                    <div className="clearRept">
                        <img src="./assets/imgs/lees-reptile.PNG" alt="Lee's Reptile Emporium" className="leesReptImg container-fluid" />
